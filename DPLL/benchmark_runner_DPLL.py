...
import re
import json
from DPLL import parse_cnf_file, run_dpll_with_timeout
...
def benchmark_solver(folder_path, timeout=60):
    ...
    print(f"Running DPLL benchmark in: {folder_path}")
    ...
    json_path = os.path.join(folder_path, "benchmark_dpll_results.json")
    with open(json_path, "w") as f:
        json.dump(summary, f, indent=4)

    print("\n--- DPLL Benchmark Summary ---")
